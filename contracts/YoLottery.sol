...
contract Pool {
    ...
    /* Functions */
    constructor(address _sender, uint _buyLimit, uint _timeInterval) payable {
        owner = payable(_sender);
        buyLimit = _buyLimit;
    ...
    function distributePool() public poolOpen {
        require(poolState == State.Running, "Pool must be in the running state");
        address ticketOwner;
    ...
    // Function to revive Ether. msg.data must be empty
